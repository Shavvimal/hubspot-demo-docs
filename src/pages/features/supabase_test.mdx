...
### Detailed Steps for Inviting New Team Members
...
3. **Access User Management**
   ...
   - Verify the list of all current users is displayed
...
6. **Send Invitation**
   ...
   - Verify the user receives an email with signup instructions